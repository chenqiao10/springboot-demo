...
(function ($, document, window) {
	...
	function makeSettings() {
		...
		settings.href = settings.href || $(element).attr('href') || $(element).attr('alt');//wuff modify20110621
	...
	publicMethod.position = function (speed, loadedCallback) {
		...
		if(isIE6)settings.animateFlag = false;//wuff modify20120107
		if(settings.animateFlag)//wuff modify20120107
		{
