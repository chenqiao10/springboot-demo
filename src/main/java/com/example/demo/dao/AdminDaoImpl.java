...
public class AdminDaoImpl implements AdminDao {
	...
	public User findByUserName(String username) {
		Query query = entityManager.createQuery("select t from User t where t.userName=?1");
		query.setParameter(1, username);
		List<User> list = query.setMaxResults(1).setFirstResult(0).getResultList();
		if (list.size() == 0)
		{
			return null;
		}
	...
	@Override
	public void insertAllStudent(List<User> list) throws RuntimeException {
		// TODO Auto-generated method stub
